        ...
        <div class="col-12 d-flex justify-content-between">
            ...
            <div class="col-5 d-flex gap-2 justify-content-end">
                <button class="btn d-flex" type="button" data-bs-toggle="modal"
                    data-bs-target="#exampleModalhead<?php echo $head[0]['id'] ?>"
            ...
            <div class="modal fade" id="exampleModalhead<?php echo $head[0]['id'] ?>" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <form action="/ubahheaderartikel" method="post" id="form-data-solusi"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 p-2 pt-0" style="text-align: left;">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1"
                                        placeholder="Masukan judul solusi" name="judul_artikel"
                                        value="<?php echo $head[0]['judul_artikel'] ?>">
                                </div>
                                <div class="col-12 mb-3 p-2 pt-0" style="text-align: left;">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="8.5"
                                        name="deskripsi"><?php echo $head[0]['deskripsi'] ?></textarea>
                                </div>
                            </div>
            ...
            <?php foreach ($artikel as $key => $value) { ?>
                <div class="card col" style="padding: 24px; height: fit-content; width: 100%; flex: 1 0 500px;">
                    <div class="card-kanan-atas">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModaleditartikel<?php echo $value['id'] ?>" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <form action="/ubahartikel" method="post" id="form-data-ubah"
                                    class="modal-dialog-scrollable" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3 p-2 pt-0" style="text-align: left;">
                                                ...
                                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                                    ...
                                                    value="<?php echo $value['nama_artikel'] ?>" name="nama_artikel"
                                                    id="deskripsi">
                                            </div>
                                            <div class="col-12 mb-3 p-2 pt-0" style="text-align: left;">
                        ...
                        <i class="ti ti-x" style="font-size: 30px;" type="button" data-bs-toggle="modal"
                            data-bs-target="#exampleModalhapusartikel<?php echo $value['id'] ?>"></i>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalhapusartikel<?php echo $value['id'] ?>" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
