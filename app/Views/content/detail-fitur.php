                                        ...
                                        <?php foreach ($layout as $key => $value) { ?>
                                            <div class="mb-3 p-2 col" style="text-align: left;">
                                                <div class=" d-flex p-2"
                                                    style="height: 150px; width: 228px;">
...
<!-- modal edit detail fitur -->
            <div class="modal fade" id="exampleModaleditdetailfitur" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <form action="/ubahdetailfitur" method="post" id="form-data-fitur" class="modal-dialog-scrollable"
                        enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 p-2 pt-0" style="text-align: left;">
                                    <label for="exampleFormControlInput1" class="form-label">Judul Detail :</label>
                                    <input type="text" class="form-control" id="judul_detail_ubah"
                                        placeholder="Masukan judul detail" name="judul_detail">
                                </div>
                                <div class="col-12 d-flex">
                                    <div class="col-6 mb-3 p-2 pt-0" style="text-align: left;">
                                        <label for="exampleFormControlTextarea1" class="form-label">Deskripsi:</label>
                                        <textarea class="form-control" id="deskripsi_ubah" rows="7.5"
                                            name="deskripsi"></textarea>
                                    </div>
                                    <div class="col-6 mb-3 p-2 pt-0" style="text-align: left;">
                                        <label for="exampleFormControlInput1" class="form-label">Gambar :</label>
            ...
            <div class="modal fade" id="exampleModalhapusdetailfitur" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
