            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        console.log(row);
                        return '<div class="d-flex gap-2"><button type="button" class="btn btn-primary d-flex btn-sm btn-detail" data-id="' + data + '" data-pesan="' + row.pesan + '">Detail</button><button type="button" class="btn btn-danger d-flex btn-sm btn-hapus-kontak" data-id="' + data + '"><i class="ti ti-trash pe-2 fs-6 align-middle p-1 "></button></div>'
                    },
                    orderable: false
                },
            ]
