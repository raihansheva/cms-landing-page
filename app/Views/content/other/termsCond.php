...
<div class="col-12">
    <div class="col-12 text-center mt-3">
        <!-- <h2><i class="ti ti-terminal-2 fs-6"></i></h2> -->
    </div>
            ...
            <div class="col-12 text-end">
                ...
                <div class="modal fade" id="exampleModaleditcanvas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <form action="/ubahterms" method="post" class="modal-dialog-scrollable" enctype="multipart/form-data">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 p-2 pt-0" style="text-align: left;">
                                        <input type="text" value="<?= $tc[0]['id'] ?>" name="id" id="id" hidden>
                                        <label for="exampleFormControlInput1" class="form-label d-flex justify-content-between">
                                            Deskripsi : </label>
                                        <textarea type="text" class="form-control" id="deskripsi" value="" name="deskripsi"><?= $tc[0]['deskripsi'] ?></textarea>
                                    </div>
                                </div>
