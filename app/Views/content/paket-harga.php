...
<style>
    .prefix {
        ...
        color: #555;
        pointer-events: none;
        /* Make sure it is not clickable or focusable */
    }
</style>
...
<div class="bungkus">
    <div class="konten-banner">
                            ...
                            <div class="modal-body">
                                <div class="col-12 d-flex">
                                    <div class="col-6 mb-3 p-2 pt-0" style="text-align: left;">
                                        ...
                                        <input type="text" class="form-control m-0" id="inputjudul" placeholder="Masukan Nama Paket" name="nama_paket" required>
                                    ...
                                    <div class="col-6 mb-3 p-2 pt-0" style="text-align: left;">
                                        ...
                                        <input type="text" class="form-control" id="kategori_harga" placeholder="Masukan kategori" name="kategori_harga" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 d-flex">
                                    ...
                                    <div class="col-6">
                                        <div class="col-12 mb-3 p-2 pt-0" style="text-align: left;">
                                            ...
                                            <input type="text" class="form-control" id="harga1" placeholder="Masukan harga" oninput="formatRupiah(this)" required>
                                            <input type="hidden" id="hargaNumeric" name="harga">
                                        </div>
        ...
        <div class="col-12 " style="height: 100%;">
            <table id="tabelharga" class="table col-12 " style="height: auto; background-color: white; border-radius: 15px;">
                <thead class="">
                    <tr class="p-2">
                        <!-- <th scope="col">No</th> -->
                ...
                <div class="modal-body">
                    <div class="col-12 d-flex">
                        <div class="col-6 mb-3 p-2 pt-0" style="text-align: left;">
                            ...
                            <input type="text" class="form-control m-0" id="nama_paket_ubah" placeholder="Masukan Nama Paket" name="nama_paket" required>
                        ...
                        <div class="col-6 mb-3 p-2 pt-0" style="text-align: left;">
                            <label for="exampleFormControlInput1" class="form-label">Kategori :</label>
                            <input type="text" class="form-control" id="kategori_harga_ubah" placeholder="Masukan kategori" name="kategori_harga" value="" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <div class="col-6">
                            <div class="col-12 mb-3 p-2 pt-0" style="text-align: left;">
                                ...
                                <input type="text" class="form-control" id="harga_ubah" placeholder="Masukan harga" oninput="formatRupiahEdit()" required>
                                <input type="hidden" id="hargaNumericUbah" name="harga">
                            </div>
                            <div class="mb-3 p-2 pt-0" style="text-align: left;">
                                <label for="exampleFormControlInput1" class="form-label">Nama Solusi
                                    :</label>
