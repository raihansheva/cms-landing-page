        ...
        <div class="col-12 d-flex justify-content-between">
            ...
            <div class="modal fade" id="exampleModaltambahbannerinformasi" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    <form action="/ubahbannerinformasi" method="post" id="form-data-solusi"
            ...
            <div class="modal fade" id="exampleModaltambahinformasi" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <form action="/tambahtentangkami" method="post" id="form-data-solusi"
                        class="modal-dialog-scrollable" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header border-bottom">
                    ...
                    <div class="card-kanan-atas">
                        ...
                        <div class="modal fade" id="exampleModaleditartikel<?= $value['id'] ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <form action="/ubahtentangkami" method="post" id="form-data-ubah"
                                    class="modal-dialog-scrollable" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3 p-2 pt-0" style="text-align: left;">
                                                <label for="exampleFormControlInput1" class="form-label">Judul
                                                    :</label>
                                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                                    placeholder="Masukan Nama Solusi" value="<?= $value['judul'] ?>"
                                                    name="judul" id="deskripsi">
                                            </div>
                                            <div class="col-12 mb-3 p-2 pt-0" style="text-align: left;">
